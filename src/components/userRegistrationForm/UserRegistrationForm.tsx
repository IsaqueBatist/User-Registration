...
const UserRegistrationForm = () => {
  ...
  const { register, control, formState: {errors}, handleSubmit, reset, setValue, clearErrors } = useForm<FormValue>({
    mode: 'onBlur',
  ...
  const handleCEPBlur = async (zipCode: string) => {
    try {
      const adress = await getAdress(zipCode); // Consultando API ViaCep ou equivalente.
      if (adress) {
  ...
  return (
    <div className="main-container">
      ...
      <form className="user-form" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="row">
          <div className="input-controler">
            <input type="text" {...register('zipCode')} placeholder="Zip Code" onBlur={(e) => handleCEPBlur(e.target.value)} />
        ...
        <div className="row">
          <div className="input-controler">
            <input type="text" disabled={isCepvalid} {...register('adress.street')} placeholder="Street"/>
        ...
        <div className="row">
          <div className="input-controler">
            <input type="text" disabled={isCepvalid} {...register('adress.country')} placeholder="Country"/>
        ...
        <div className="row">
          <div className="input-controler">
            <input type="text" disabled={isCepvalid} {...register('adress.city')} placeholder="City"/>
            {errors.adress?.city && <p className="error">{errors.adress?.city.message}</p>}
          </div>

          <div className="input-controler">
            <input type="text" disabled={isCepvalid} {...register('adress.state')} placeholder="State"/>
